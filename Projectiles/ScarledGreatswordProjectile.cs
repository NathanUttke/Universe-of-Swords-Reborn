...
namespace UniverseOfSwordsMod.Projectiles
{
    internal class ScarledGreatswordProjectile : DragonsDeathProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), playerCenter, velocity * shootSpeed, ModContent.ProjectileType<FlareCore>(), Projectile.damage * 2, Projectile.knockBack, player.whoAmI);
                Projectile.ai[0] += 1f;
            }
