...
public class TheEater : ModItem
{
    ...
    {
        Projectile.NewProjectile(source, position, new Vector2(velocity.X * Utils.SelectRandom(Main.rand, -1, 1, 1, -1, 1, -1), velocity.Y), Item.shoot, (int)(Item.damage * 0.15f + Main.rand.Next(1, 3)), 4f, player.whoAmI);
        return false;
    }
