...
public class SwordOfTheUniverse : ModItem
{
	...
	public override void SetDefaults()
	{
		...
		Item.shoot = Mod.Find<ModProjectile>("SOTUProjectile1").Type;
		Item.shootSpeed = 30f;
		Item.expert = true;
	...
	public override void AddRecipes()
	{
		...
		val2.AddIngredient(Mod, "SwordOfTheUniverseV9", 1);
		val2.Register();
		Recipe val3 = CreateRecipe(1);
		val3.AddIngredient(Mod, "SwordOfTheUniverseV3", 1);
		val3.Register();
		...
		val6.AddIngredient(Mod, "SwordOfTheUniverseV6", 1);
		val6.Register();
		Recipe val7 = CreateRecipe(1);
		val7.AddIngredient(Mod, "SwordOfTheUniverseV7", 1);
		val7.Register();
		Recipe val8 = CreateRecipe(1);
		val8.AddIngredient(Mod, "SwordOfTheUniverseV8", 1);
		val8.Register();
	}
